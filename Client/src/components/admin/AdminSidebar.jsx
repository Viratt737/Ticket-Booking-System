import { LayoutDashboardIcon, ListCollapseIcon, ListIcon, PlusSquareIcon, Building2Icon } from 'lucide-react'
...
const AdminSidebar = () => {
    ...
    const adminNavlinks = [
        ...
        { name: 'Manage Venues', path: '/admin/venues', icon: Building2Icon },
    ]
